...
function InvestmentInsurance() {
  ...
  <div className="mt-3 text-center">
    <h2><b>Top 5 Investment Insurance Policies</b></h2>
        ...
        {policy.map((p, index) => (
          ...
          <tr key={index} style={{ textAlign: 'center' }}>
            ...
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>
             <button
  style={{ padding: '6px 12px', backgroundColor: '#b7aadf', color: '#fff', border: 'none', borderRadius: '4px' }}
  ...
  <strong>Buy</strong>
    ...
    <h4 className="card-title mt-3 text-center"><b>What is Investment Insurance?</b></h4>
                    <p>Investment insurance offers financial coverage to policyholder’s dependants 
                        if they meet an unfortunate demise during the policy Investment. Let us understand it 
                        ...
                        this plan will financially replace them in both of these. Thus, Investment life insurance plans 
                        will financially support your dependents even if you are not around. 
                        Scroll through the section to know all about Investment insurance plans.</p>
    
                        <h4 className="card-title mt-3 text-center"><b>Best Investment Life Insurance Plans in India 2025</b></h4>
                        <p className="card-title mt-3 text-center">The top 5 Investment insurance plans are as follows:</p>
                        <h5>1. Max Life Smart Secure Plus</h5>
                    <p>The Max Life Smart Secure Plus Plan is like a financial safety net for your family. This Investment insurance plan is made to meet your financial needs and provide reliable help during tough times. The Smart Secure Plus Plan by Max Life gives you two types of death benefits: one for terminal illness and another as an exit value. On top of that, you can choose extra benefits like breaks in premium payments, coverage for both partners and added payouts for accidental death. It's not just a Investment insurance plan; it is a solution to keep your finances secure and adapt to any unexpected changes.</p>
    <h5>2. ICICI iProtect Smart</h5>
    <p>The ICICI iProtect Smart Investment Insurance Plan offers enhanced protection with coverage against death, terminal illness, and disability. It provides comprehensive additional benefits, allowing policyholders to choose options such as accidental death benefit and accelerated critical illness benefit. Special premium rates are available for non-tobacco users, making it an attractive choice for those who maintain a healthy lifestyle.</p>
    <h5>3. HDFC Life Click 2 Protect Super</h5>
    <p>HDFC Life Click 2 Protect Super is a versatile Investment insurance plan designed to cater to your changing needs, offering a dynamic life cover and comprehensive protection. This plan understands the evolving nature of your life and provides a range of coverage options tailored to your specific requirements. With the flexibility to choose from multiple coverage options, the plan ensures that your income is safeguarded.<br/>
    ...
    <p>Tata AIA Samporn Raksha Supreme is a comprehensive Investment insurance plan offering various benefits to secure your family's financial future in your absence. One of the key advantages of this plan is the opportunity to avail tax benefits in accordance with applicable income tax laws. The plan also provides a flexible premium payment structure, allowing you to choose from various options such as single, monthly, half-yearly, quarterly, or yearly payments, ensuring convenience.<br/>
    ...
    The plan offers four distinct options, namely Life Option, Life Plus Option, Life Income Option, and Credit Protect Option, each tailored to meet specific insurance needs. Women policyholders can enjoy preferential premium rates, providing an added advantage.</p>
        ...
        <p>Bajaj Allianz Life eTouch Online Investment is a valuable Investment life insurance plan designed to offer comprehensive protection for individuals. The plan falls under the category of non-linked, non-participating, life, regular premium payment, individual, and pure risk premium plans. This means it's a simple, easy-to-understand policy that focuses on providing coverage without any complicated financial components. The Bajaj Allianz Life eTouch Online Investment plan not only offers life cover but also includes benefits for accidental death, accidental total permanent disability, and critical illness. What sets it apart is the flexibility it provides!<br/>
