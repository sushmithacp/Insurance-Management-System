...
function GuaranteedInsurance() {
     const [policy, setPolicy] = useState(null);
              ...
              useEffect(() => {
                axios.get('http://localhost:5000/api/investmentPolicies') 
  ...
  <div className="mt-3 text-center">
    <h2><b>Top 5 Guaranteed Insurance Policies</b></h2>
    <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '20px' }}>
      <thead>
        <tr style={{ backgroundColor: '#f2f2f2' }}>
          <th style={{ border: '1px solid #ddd', padding: '8px' }}>Guaranteed Policy ID</th>
          <th style={{ border: '1px solid #ddd', padding: '8px' }}>Guaranteed Policy Number</th>
        ...
        {policy.map((p, index) => (
          ...
          <tr key={index} style={{ textAlign: 'center' }}>
            ...
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>
             <button
  style={{ padding: '6px 12px', backgroundColor: '#b6d279', color: '#fff', border: 'none', borderRadius: '4px' }}
